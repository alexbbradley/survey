...
This should take about 5–10 minutes. Thanks for your time.',
    ...
    'questions' => [
        ...
        [
            ...
            'questions' => [
                ...
                [
                    'key'         => 'role',
                    'type'        => 'text',
                    'label'       => 'Your role in the One Clanwilliam Project?',
                    'placeholder' => 'e.g. Asset Management, Development, Agent',
                    'required'    => true,
                ],
            ],
        ],
        ...
        [
            ...
            'summary'  => true,
            'options'  => [
                ['label' => 'Essential',     'description' => 'The site should feel highly distinctive and premium.'],
                ['label' => 'Important',     'description' => 'But only where it supports the content.'],
                ['label' => 'Nice to have',  'description' => 'Polish matters, but clarity is more important.'],
                ['label' => 'Low priority',  'description' => 'A simpler brochure-style site is enough.'],
                'Not sure',
            ],
        ],
        ...
        [
            ...
            'description' => 'Drag to rank. 1 is the most critical.',
            'required'    => true,
            'summary'     => true,
            'items'       => [
                'Video / motion assets',
